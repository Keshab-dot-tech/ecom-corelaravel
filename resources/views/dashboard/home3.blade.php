<x-layouts.app>
 ...
 <section class="hero-video">
      <video muted loop poster="img/video/Bed-Phone.jpg" class="bg-video">
        <source src="https://demo.bootstrapious.com/hub/1-4-0/img/video/Bed-Phone.webm" type="video/webm">
        <source src="https://demo.bootstrapious.com/hub/1-4-0/img/video/Bed-Phone.mp4" type="video/mp4">
      </video>
      <div class="container position-relative text-white text-center">
        <div class="row">
          <div class="col-xl-7 mx-auto">
            <h1 class="text-uppercase text-shadow letter-spacing-2 mb-4">New phones are here</h1>
            <hr class="bg-light m-5">
            <p class="lead mb-5">Proin mattis lacinia justo. Mauris tincidunt sem sed arcu. Vivamus ac leo pretium faucibus. Nullam at arcu a est sollicitudin euismod. In convallis. </p><a href="#" class="btn btn-outline-light px-4 shop-now">Shop Now<i class="icon-bag"> </i></a>
          </div>
        </div>
      </div>
    </section>
